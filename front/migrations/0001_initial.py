...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'front_startup', (
            ...
            ('short_profile', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
        ...
        db.send_create_signal(u'front', ['Startup'])
        ...
        db.create_table(u'front_job', (
            ...
            ('apply', self.gf('django.db.models.fields.TextField')()),
            ('salary', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('published', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'front', ['Job'])


    def backwards(self, orm):
        # Deleting model 'Startup'
        db.delete_table(u'front_startup')

        # Deleting model 'StartupAddress'
        db.delete_table(u'front_startupaddress')

        # Deleting model 'Job'
        db.delete_table(u'front_job')
    ...
    models = {
        ...
        u'front.startupaddress': {
            'Meta': {'object_name': 'StartupAddress'},
