...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinkedinCompany'
        db.create_table(u'front_linkedincompany', (
        ...
        db.send_create_signal(u'front', ['LinkedinCompany'])


        # Changing field 'Position.company'
        db.alter_column(u'front_position', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.LinkedinCompany']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LinkedinCompany'
        db.delete_table(u'front_linkedincompany')


        # Changing field 'Position.company'
        db.alter_column(u'front_position', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.LinkedinCompay']))
