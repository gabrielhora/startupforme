...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.linkedin_authorization_code'
        db.add_column(u'front_person', 'linkedin_authorization_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Person.linkedin_last_authorization_date'
        db.add_column(u'front_person', 'linkedin_last_authorization_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.linkedin_authorization_code'
        db.delete_column(u'front_person', 'linkedin_authorization_code')

        # Deleting field 'Person.linkedin_last_authorization_date'
        db.delete_column(u'front_person', 'linkedin_last_authorization_date')
