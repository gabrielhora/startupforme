...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'front_person', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=768),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.full_name'
        db.delete_column(u'front_person', 'full_name')
    ...
    models = {
        ...
        u'front.person': {
            ...
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '768'}),
