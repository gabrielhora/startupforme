...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.num_recommenders'
        db.add_column(u'front_person', 'num_recommenders',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.num_recommenders'
        db.delete_column(u'front_person', 'num_recommenders')
