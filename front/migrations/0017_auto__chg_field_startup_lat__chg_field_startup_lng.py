...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Startup.lat'
        db.alter_column(u'front_startup', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

        # Changing field 'Startup.lng'
        db.alter_column(u'front_startup', 'lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

    def backwards(self, orm):

        # Changing field 'Startup.lat'
        db.alter_column(u'front_startup', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=13, decimal_places=10))

        # Changing field 'Startup.lng'
        db.alter_column(u'front_startup', 'lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=13, decimal_places=10))
