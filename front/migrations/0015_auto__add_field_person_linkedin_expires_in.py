...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.linkedin_expires_in'
        db.add_column(u'front_person', 'linkedin_expires_in',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.linkedin_expires_in'
        db.delete_column(u'front_person', 'linkedin_expires_in')
