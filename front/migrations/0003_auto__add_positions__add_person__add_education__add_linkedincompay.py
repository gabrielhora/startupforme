...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'front_positions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.Person'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.LinkedinCompay'])),
            ...
            ('start_date_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('start_date_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('end_date_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('end_date_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'front', ['Positions'])

        # Adding model 'Person'
        db.create_table(u'front_person', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('num_connections', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('specialties', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'front', ['Person'])

        # Adding model 'Education'
        db.create_table(u'front_education', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.Person'])),
            ('linkedin_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('school_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('field_of_study', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('degree', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'front', ['Education'])

        # Adding model 'LinkedinCompay'
        db.create_table(u'front_linkedincompay', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'front', ['LinkedinCompay'])


    def backwards(self, orm):
        # Deleting model 'Positions'
        db.delete_table(u'front_positions')

        # Deleting model 'Person'
        db.delete_table(u'front_person')

        # Deleting model 'Education'
        db.delete_table(u'front_education')

        # Deleting model 'LinkedinCompay'
        db.delete_table(u'front_linkedincompay')
    ...
    models = {
        ...
        u'front.linkedincompay': {
            'Meta': {'object_name': 'LinkedinCompay'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'front.positions': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['front.LinkedinCompay']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
