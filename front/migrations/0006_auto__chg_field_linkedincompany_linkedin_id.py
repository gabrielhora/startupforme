...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkedinCompany.linkedin_id'
        db.alter_column(u'front_linkedincompany', 'linkedin_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'LinkedinCompany.linkedin_id'
        db.alter_column(u'front_linkedincompany', 'linkedin_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
