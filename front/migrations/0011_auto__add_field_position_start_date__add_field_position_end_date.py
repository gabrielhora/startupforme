...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Position.start_date'
        db.add_column(u'front_position', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.end_date'
        db.add_column(u'front_position', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Position.start_date'
        db.delete_column(u'front_position', 'start_date')

        # Deleting field 'Position.end_date'
        db.delete_column(u'front_position', 'end_date')
