...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.num_connections_capped'
        db.add_column(u'front_person', 'num_connections_capped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.num_connections_capped'
        db.delete_column(u'front_person', 'num_connections_capped')
